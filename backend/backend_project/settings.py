...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-bi6p^z*t9!dnn-8fk8w(s%_k=$undbw_#@iex0(--sgef(ywy*')
...
# Media files (audio/video recordings)
MEDIA_URL = '/media/'
...
# Celery a été supprimé - les tâches sont maintenant synchrones
...
ALLOWED_AUDIO_FORMATS = ['mp3', 'wav', 'ogg', 'm4a', 'flac', 'webm']
